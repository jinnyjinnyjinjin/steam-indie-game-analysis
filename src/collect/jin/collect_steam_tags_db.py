...
DEFAULT_INPUT = os.path.join(PROJECT_ROOT, "data/processed/steam_stratified_sample.csv")
# 수집 완료된 appid를 기록할 JSON 로그 파일
CHECKPOINT_PATH = os.path.join(PROJECT_ROOT, "data/raw/collect_tags_checkpoint.json")
BATCH_SIZE = 20
